...
export function DistrictKYC() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Main KYC Table */}
      <DataTable
        title="District Vendor KYC Queue"
        subtitle="Review identity documents and compliance clearance for district vendors"
        columns={columns}
        data={kycList}
        loading={loading}
        onRefresh={loadData}
        ...
        exportFileName="district_vendor_kyc.csv"
      />
