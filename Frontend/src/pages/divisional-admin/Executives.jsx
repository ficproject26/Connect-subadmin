...
export function DivisionalExecutives() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-bold text-slate-900 dark:text-white">Divisional Vendor Executives</h2>
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Vendor-assigned operations personnel managing stay and travel bookings in {user?.division ? `${user.division} Division` : 'assigned division'}.
        </p>
      </div>
      ...
      <DataTable
        title="Divisional Operations Team"
        ...
        exportFileName="divisional_executives.csv"
      />
