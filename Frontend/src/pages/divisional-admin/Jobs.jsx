...
export function DivisionalJobs() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white">Division Job Applications</h2>
        <p className="text-xs text-slate-500 dark:text-slate-400">Applications submitted for vendor jobs in this Division.</p>
      </div>
      ...
      <DataTable
        title="Division Applications Board"
